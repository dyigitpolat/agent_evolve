...
def reauthor_generator(
    ...
    *,
    ...
    search rather than to repair its own output.
    """
...
class AuthoredGenerator:
    ...
    def propose(
        ...
        *,
        ...
        # The generator SAMPLES from the (possibly narrowed) domains and is
        ...
        report = validate_pool(
            ...
            template=template, domains=declared, seen=self._seen, limit=n,
        )
